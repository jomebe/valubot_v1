...
/**
 * 로그인에 사용될 Embed와 Component(버튼) 빌더
 */
export function buildLoginPayload(userId) {
  ...
  if (loginFlow === 'rso') {
    ...
    embed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        '💡 현재 Riot RSO 승인 대기 중이라 임시 로그인 방식을 사용하고 있습니다. 이 방식은 세션이 오래 유지되지 않을 수 있어, 만료되면 다시 로그인해야 합니다.'
      )
